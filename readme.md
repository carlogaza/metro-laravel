...
Metro Laravel  is a sample application for beginning development with Laravel 4.
...
* Front-end
	...
	* User account area
	* Simple Blog functionality with google code pretify
...
## Issues
See [github issue list](https://github.com/turahe/metro-laravel/issues) for current list.
...
```bash
$ git clone git://github.com/turahe/metro-laravel.git laravel
```

#### Option 2: Download the repository

    https://github.com/turahe/metro-laravel/archive/master.zip
	
### Option 3: Download with Composer
		composer require turahe/metro
